...
import DetailMobile from "@components/mobile/resetPasswordEmailSent/Detail";
...
const DetailTablet = lazy(() => import("@components/tablet/resetPasswordEmailSent/Detail"));
