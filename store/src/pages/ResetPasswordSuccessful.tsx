...
import DetailMobile from "@components/mobile/resetPasswordSuccessful/Detail";
...
const DetailTablet = lazy(() => import("@components/tablet/resetPasswordSuccessful/Detail"));
