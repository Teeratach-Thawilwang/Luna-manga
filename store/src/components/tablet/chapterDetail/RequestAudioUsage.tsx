...
const CancelButton = styled(BaseButton)`
  /* border: 1px solid red; */
  color: ${(props) => color(props).onError};
  background-color: ${(props) => darken(0.1, color(props).error)};

  &:hover {
    background-color: ${(props) => darken(1.1 - font(props).opacity.hover, color(props).error)};
  }

  &:active {
    background-color: ${(props) => darken(1.1 - font(props).opacity.active, color(props).error)};
  }
`;
