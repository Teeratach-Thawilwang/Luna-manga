...
import BookmarkContent from "@components/tablet/bookmarkDetail/BookmarkContent";
import BookmarkHeader from "@components/tablet/bookmarkDetail/BookmarkHeader";
