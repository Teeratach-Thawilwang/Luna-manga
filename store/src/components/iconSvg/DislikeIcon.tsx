  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="9" cy="10" r="1.25" fill="white" stroke="white" strokeWidth="0.5" strokeLinecap="round" />
      <circle cx="15" cy="10" r="1.25" fill="white" stroke="white" strokeWidth="0.5" strokeLinecap="round" />
    </svg>
  );
}
