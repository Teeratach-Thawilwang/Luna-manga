import { ChapterReactionParams, ChapterReactionResponse, ChapterShowParams, ChapterShowResponse } from "@interfaces/ChapterInterface";
...
class ChapterApi {
  ...
  private async getMockApi() {
    if (import.meta.env.VITE_IS_MOCK_DATA === "true") {
      const module = await import("@mocks/ChapterMockApi");
