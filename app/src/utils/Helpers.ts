...
export function transformBannerType(type: BannerTypeEnum): string {
  switch (type) {
    ...
    case BannerTypeEnum.ADVERTISEMENT_SMALL:
      return "Advertisement Small";
    case BannerTypeEnum.ADVERTISEMENT_MEDIUM:
      return "Advertisement Medium";
    case BannerTypeEnum.ADVERTISEMENT_GROUP:
      return "Advertisement Group";
    default:
      return "";
  }
}

export function transformWidgetType(type: WidgetTypeEnum): string {
  switch (type) {
...
export function transformCustomerReportGroup(group: CustomerReportGroupEnum): string {
  switch (group) {
    case CustomerReportGroupEnum.COPYRIGHT_INFRINGEMENT:
      return "Copyright Infringement";
    case CustomerReportGroupEnum.INAPPROPRIATELY_RATED:
      return "Inappropriately Rated";
    case CustomerReportGroupEnum.SEXUAL:
      return "Sexual";
    case CustomerReportGroupEnum.UNRELATED:
      return "Unrelated";
    case CustomerReportGroupEnum.HATE_SPEECH:
      return "Hate Speech";
    case CustomerReportGroupEnum.SPAM:
      return "Spam";
    case CustomerReportGroupEnum.OTHER:
      return "Other";
    default:
      return "";
  }
...
export function hasPermission(permission: PermissionEnum, userPermissions: PermissionListInterface[] | null): boolean {
