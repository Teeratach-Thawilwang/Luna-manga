...
const BoxLoading = styled.div`
  ...
  left: 50%;
  transform: ${(props) => `translate(-50%, calc(-50% + ${getContainerPaddingBottom(props)}/2))`} scale(0.6);
...
function getContainerPaddingBottom(props: any) {
  ...
  const ChapterNumberHeight = `2*${box(props).space.xs} + ${font(props).lineHeight.sm}`;
