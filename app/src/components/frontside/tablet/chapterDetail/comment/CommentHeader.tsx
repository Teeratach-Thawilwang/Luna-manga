...
import InputCommentBox from "@components/frontside/tablet/comment/InputCommentBox";
...
export default function CommentHeader() {
  ...
  const CommentBox = getCommentInputBox(chapterId, customerId);
...
function getCommentInputBox(chapterId: number | null, customerId: number | null) {
  if (customerId != null && chapterId != null) {
