...
import ComfirmModalButton from "@components/frontside/mobile/chapterDetail/comment/ComfirmModalButton";
...
export default function ReportCommentConfirmModal({ group, text, customerId, commentIdId, setShow }: ReportPostConfirmModalInterface) {
  ...
  return (
    <Box>
      {titleText}
      <Text>{text}</Text>
      <ComfirmModalButton group={group} customerId={customerId} commentId={commentIdId} setShow={setShow} />
    </Box>
  );
}
