import ReportCommentModal from "@components/frontside/mobile/chapterDetail/comment/ReportCommentModal";
import CommentList from "@components/frontside/mobile/comment/CommentList";
...
export default function CommentListWrap() {
  ...
  function onSeeMoreClick() {
    ChapterCommentService.loadIndex(chapter!.id, paginate!.next!, 10);
  }
