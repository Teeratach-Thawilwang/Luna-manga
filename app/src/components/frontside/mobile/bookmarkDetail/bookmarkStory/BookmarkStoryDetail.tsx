...
import BookmarkStoryRatingViewCount from "@components/frontside/mobile/bookmarkDetail/bookmarkStory/BookmarkStoryRatingViewCount";
import BookmarkStoryType from "@components/frontside/mobile/bookmarkDetail/bookmarkStory/BookmarkStoryType";
