...
export default function FilterStatus() {
  ...
  const status = BannerListService.getStatus();
  ...
  function onDropDownHandle(status: BannerStatusEnum | null) {
    BannerListService.updateFilter({ status: status });
    setIsOpen(false);
  ...
  return (
    <Box ref={dropDownRef}>
      ...
      <DropdownContent $isOpen={isOpen}>
        ...
        <DropdownItem onClick={() => onDropDownHandle(BannerStatusEnum.ACTIVE)}>Active</DropdownItem>
        <DropdownItem onClick={() => onDropDownHandle(BannerStatusEnum.INACTIVE)}>Inactive</DropdownItem>
      </DropdownContent>
    </Box>
  );
}
