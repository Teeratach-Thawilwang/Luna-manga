...
export default function FilterStatus() {
  ...
  const status = StoryListService.getStatus();
  ...
  function onDropDownHandle(status: StoryStatusEnum | null) {
    StoryListService.updateFilter({ status: status });
    setIsOpen(false);
  ...
  return (
    <Box ref={dropDownRef}>
      ...
      <DropdownContent $isOpen={isOpen}>
        ...
        <DropdownItem onClick={() => onDropDownHandle(StoryStatusEnum.ONGOING)}>Ongoing</DropdownItem>
        <DropdownItem onClick={() => onDropDownHandle(StoryStatusEnum.INACTIVE)}>Inactive</DropdownItem>
        <DropdownItem onClick={() => onDropDownHandle(StoryStatusEnum.FINISHED)}>Finished</DropdownItem>
      </DropdownContent>
    </Box>
  );
}
