...
import InputImageAdvertisementMedium from "@components/backoffice/bannerForm/InputImageAdvertisementMedium";
...
export default function InputImageTypeAdvertisementMedium({ initial }: { initial?: ImageInterface[] }) {
