...
export default function FilterStatus() {
  ...
  const status = CustomerListService.getStatus();
  ...
  function onDropDownHandle(status: CustomerStatusEnum | null) {
    CustomerListService.updateFilter({ status: status });
    setIsOpen(false);
  ...
  return (
    <Box ref={dropDownRef}>
      ...
      <DropdownContent $isOpen={isOpen}>
        ...
        <DropdownItem onClick={() => onDropDownHandle(CustomerStatusEnum.ACTIVE)}>Active</DropdownItem>
        <DropdownItem onClick={() => onDropDownHandle(CustomerStatusEnum.INACTIVE)}>Inactive</DropdownItem>
      </DropdownContent>
    </Box>
  );
}
