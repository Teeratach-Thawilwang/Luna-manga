...
export default function ChapterListPagination({ navigatePagination }: { navigatePagination: (page: number) => void }) {
  // console.log("In ChapterListPagination");
  const paginate = ChapterListService.getPaginate();
