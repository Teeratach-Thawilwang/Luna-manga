...
export default function FilterStatus() {
  ...
  const status = CustomerGroupListService.getStatus();
  ...
  function onDropDownHandle(status: CustomerGroupStatusEnum | null) {
    CustomerGroupListService.updateFilter({ status: status });
    setIsOpen(false);
  ...
  return (
    <Box ref={dropDownRef}>
      ...
      <DropdownContent $isOpen={isOpen}>
        ...
        <DropdownItem onClick={() => onDropDownHandle(CustomerGroupStatusEnum.ACTIVE)}>Active</DropdownItem>
        <DropdownItem onClick={() => onDropDownHandle(CustomerGroupStatusEnum.INACTIVE)}>Inactive</DropdownItem>
      </DropdownContent>
    </Box>
  );
}
