...
import SearchLoading from "@components/backoffice/chapterForm/SearchLoading";
import StorySearchListItem from "@components/backoffice/chapterForm/StorySearchListItem";
...
export default function StorySearchBox() {
  ...
  const type = ChapterCreateEditService.getter<CategoryTypeEnum | null>("type") ?? CategoryTypeEnum.MANGA;
