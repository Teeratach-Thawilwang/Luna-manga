...
import { ChapterDetailReportInterface } from "@interfaces/backoffice/CustomerReportInterface";
...
export default function ChapterDetail() {
  const data = CustomerReportService.getter<ChapterDetailReportInterface>("data");
  ...
  return (
    <Box>
      <Header>Chapter Detail</Header>
      <Content>
        <Text>
          Id: <b>{data.id}</b>
        </Text>
        <Text>
          Chapter Number: <b>{data.chapter_number}</b>
        </Text>
        <Text>
          Chapter Name: <b>{data.name}</b>
        </Text>
        <Text>
          Link to Chapter:&nbsp;
          <Link href={`/story/${data.story.slug}/${data.chapter_number}`} target="_blank">
            Link
          </Link>
        </Text>
