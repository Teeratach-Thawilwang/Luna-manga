...
import { PostDetailReportInterface } from "@interfaces/backoffice/CustomerReportInterface";
...
export default function PostDetail() {
  const data = CustomerReportService.getter<PostDetailReportInterface>("data");
  ...
  return (
    <Box>
      ...
      <Content>
        ...
        <Text>
          Link to Profile:&nbsp;
          <Link href={`/profile/${data.commenter.id}`} target="_blank">
            Link
          </Link>
        </Text>
        <Text>
          Post: <br /> <Message>{data.message}</Message>
        </Text>
