...
import ConfirmDeleteModal from "@components/backoffice/customerGroupDetail/ConfirmDeleteModal";
...
export default function FooterControl() {
  ...
  async function onUpdate() {
    ...
    setIsUploading(true);
    setPercentBar(100);
    CustomerGroupCreateEditService.updateCustomerGroup(Number(id!), state.name!, state.status!);
  }
  ...
  function onDelete() {
    ...
    setIsDeleting(true);
    CustomerGroupCreateEditService.deleteCustomerGroup(Number(id!));
  }
