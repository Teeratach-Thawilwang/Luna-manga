...
export default function AddImageButton() {
  ...
  return (
    <Box>
      <IconBox htmlFor="input-image">
        <ImageIcon />
      </IconBox>
      <Input type="file" accept="image/*" id="input-image" onChange={onChangeHandle} />
    </Box>
  );
}
...
function createImageNode(file: File) {
  return {
...
function insertNode(editor: BaseEditor, file: File) {
  Transforms.insertNodes(editor, createImageNode(file));
